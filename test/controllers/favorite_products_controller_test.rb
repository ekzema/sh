...
class FavoriteProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite_product" do
    assert_difference('FavoriteProduct.count') do
      post favorite_products_url, params: { favorite_product: { products_id: @favorite_product.products_id, sellers_id: @favorite_product.sellers_id } }
    end
  ...
  test "should update favorite_product" do
    patch favorite_product_url(@favorite_product), params: { favorite_product: { products_id: @favorite_product.products_id, sellers_id: @favorite_product.sellers_id } }
